...
\`\`\`markdown-ui-widget
{
  "type": "form",
  "id": "streaming-form",
  "submitLabel": "Submit Stream Config",
  "fields": [
    { "type": "buttonGroup", "id": "model", "label": "LLM Model", "choices": ["GPT-4", "Claude", "Gemini"], "default": "Claude" },
    { "type": "slider", "id": "temperature", "label": "Temperature", "min": 0, "max": 2, "step": 0.1, "default": 0.7 },
    { "type": "textInput", "id": "prompt", "label": "System Prompt", "placeholder": "Enter your system prompt...", "default": "You are a helpful assistant." }
  ]
}
\`\`\`
